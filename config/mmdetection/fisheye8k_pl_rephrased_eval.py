...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(img='train-R_rephrased-gen-eval/images/'),
        pipeline=test_pipeline,
    ),
)

test_evaluator = dict(ann_file=data_root + '/' + 'train-R_rephrased-gen-eval/train-R_rephrased-gen-eval_with_dummy.json')
