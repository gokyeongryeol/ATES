...
test_dataloader = dict(
    ...
    dataset=dict(
        data_root=data_root,
        metainfo=metainfo,
        ann_file='train-D_automatic_v2-gen/train-D_automatic_v2-gen_with_dummy.json',
        data_prefix=dict(img='train-D_automatic_v2-gen/images/'),
        pipeline=test_pipeline,
    ),
)

# metric
test_evaluator = dict(ann_file=data_root + 'train-D_automatic_v2-gen/train-D_automatic_v2-gen_with_dummy.json')
