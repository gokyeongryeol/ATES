...
test_dataloader = dict(
    ...
    dataset=dict(
        data_root=data_root,
        metainfo=metainfo,
        ann_file='train-D_manual_v1-gen/train-D_manual_v1-gen_with_dummy.json',
        data_prefix=dict(img='train-D_manual_v1-gen/images/'),
        pipeline=test_pipeline,
    ),
)

# metric
test_evaluator = dict(ann_file=data_root + 'train-D_manual_v1-gen/train-D_manual_v1-gen_with_dummy.json')
