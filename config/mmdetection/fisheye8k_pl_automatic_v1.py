...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(img='train-D_automatic_v1-gen/images/'),
        pipeline=test_pipeline,
    ),
)

test_evaluator = dict(ann_file=data_root + '/' + 'train-D_automatic_v1-gen/train-D_automatic_v1-gen_with_dummy.json')
